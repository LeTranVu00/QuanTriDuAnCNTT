                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_2">Khóa học Zoom</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Tất cả khóa học</a>

                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item" href="topics-listing.html">Lập trình robot</a></li>
                                    <li><a class="dropdown-item" href="topics-listing.html">Lập trình robot</a></li>
                                    <li><a class="dropdown-item" href="topics-listing.html">Lập trình robot</a></li>
                                    <li><a class="dropdown-item" href="topics-listing.html">Lập trình robot</a></li>
...
<div class="user-profile d-flex align-items-center" style="gap: 10px;">
    <?php if (isset($_SESSION['username'])): ?>
        <!-- Dropdown Xin chào -->
        <div class="dropdown">
            <a class="login-button dropdown-toggle" href="#" id="userMenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Xin chào, <?php echo htmlspecialchars($_SESSION['username']); ?>
            </a>
            <ul class="dropdown-menu" aria-labelledby="userMenu">
                <li><a class="dropdown-item" href="account.php">Thông tin cá nhân</a></li>
                <li><a class="dropdown-item" href="my-courses.php">Khóa học của bạn</a></li>
                <li><a class="dropdown-item" href="logout.php">Đăng xuất</a></li>
            </ul>
        </div>

        <!-- Nút Dark Mode với icon -->
        <i id="toggleDarkMode" class="fa-solid fa-circle-half-stroke" style="font-size: 20px; cursor: pointer;"></i>
    <?php else: ?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">Học, học nữa, học mãi</h1>

                            <h6 class="text-center">Khóa học chất lượng cao, nền tảng kiến thức vững chắc</h6>
                            ...
                            <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input name="keyword" type="search" class="form-control" id="keyword" placeholder="Tìm kiếm..." aria-label="Search">
                    ...
                    <div class="row">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="design-tab" data-bs-toggle="tab" data-bs-target="#design-tab-pane" type="button" role="tab" aria-controls="design-tab-pane" aria-selected="true">C/C++</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="marketing-tab" data-bs-toggle="tab" data-bs-target="#marketing-tab-pane" type="button" role="tab" aria-controls="marketing-tab-pane" aria-selected="false">Python</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="finance-tab" data-bs-toggle="tab" data-bs-target="#finance-tab-pane" type="button" role="tab" aria-controls="finance-tab-pane" aria-selected="false">Java</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="music-tab" data-bs-toggle="tab" data-bs-target="#music-tab-pane" type="button" role="tab" aria-controls="music-tab-pane" aria-selected="false">Fullstack</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="education-tab" data-bs-toggle="tab" data-bs-target="#education-tab-pane" type="button" role="tab" aria-controls="education-tab-pane" aria-selected="false">Vi mạch</button>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2">Kỹ thuật lập trình</h5>

                                                            <p class="mb-0">Rèn luyện tư duy lập trình</p>
                                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2">Cấu trúc dữ liệu và giải thuật</h5>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-2">Lập trình hướng đối tượng</h5>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (toggleDarkModeBtn) {
        ...
        // Khôi phục trạng thái dark mode khi load lại trang
